...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <asp:Button CssClass="btn btn-outline-danger" ID="btnEliminarProfe" runat="server" Text="Retirar Profesor" />
            </div>
        </div>

        <hr class="mt-lg-5 mb-lg-5" />

        <asp:GridView ID="GrdVerProfesores" CssClass="mt-lg-5 mb-lg-5" AllowPaging="True" runat="server" AutoGenerateColumns="False" CellPadding="5" EmptyDataText="No se registran profesores escogidos." GridLines="None" Width="100%" ForeColor="#333333" PageSize="5">
        ...
        <div class="input-group mt-lg-5 mb-lg-5 justify-content-center">
            <asp:Button ID="btnSiguiente" CssClass="btn btn-primary btn-lg mt-5 ms-5" runat="server" Text="Siguiente" />
        </div>
